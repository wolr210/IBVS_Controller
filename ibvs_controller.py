...
if __name__ == '__main__':
    ...
    xz_controller = IBVS_Controller(control_mode='2xz', interaction_mode='curr', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 2: 2DOF xz controller, curr mode, move backward ###")
    xz_controller.set_desired_points(desired_pts=pts_2_center_far)
    xz_controller.set_current_points(curr_pts=pts_2_center_near)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 3: 2DOF xz controller, curr mode, move left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 4: 2DOF xz controller, curr mode, move right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 5: 2DOF xz controller, desired mode, move forward ###")
    xz_controller = IBVS_Controller(control_mode='2xz', interaction_mode='desired', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 7: 2DOF xz controller, desired mode, move left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 8: 2DOF xz controller, desired mode, move right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    xz_controller = IBVS_Controller(control_mode='2xz', interaction_mode='mean', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 11: 2DOF xz controller, mean mode, move left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 12: 2DOF xz controller, mean mode, move right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    xz_controller = IBVS_Controller(control_mode='2zy', interaction_mode='curr', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 15: 2DOF zy controller, curr mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 16: 2DOF zy controller, curr mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    xz_controller = IBVS_Controller(control_mode='2zy', interaction_mode='desired', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 19: 2DOF zy controller, desired mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 20: 2DOF zy controller, desired mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    xz_controller = IBVS_Controller(control_mode='2zy', interaction_mode='mean', num_pts=2)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_2_center_near)
    xz_controller.set_current_points(curr_pts=pts_2_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 23: 2DOF zy controller, mean mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_2_left)
    xz_controller.set_current_points(curr_pts=pts_2_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 24: 2DOF zy controller, mean mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_2_right)
    xz_controller.set_current_points(curr_pts=pts_2_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    xz_controller = IBVS_Controller(control_mode='4xyzy', interaction_mode='curr', num_pts=4)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0, 5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_4_center_near)
    xz_controller.set_current_points(curr_pts=pts_4_center_far)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 26: 4DOF xyzy controller, curr mode, move backward ###")
    xz_controller.set_desired_points(desired_pts=pts_4_center_far)
    xz_controller.set_current_points(curr_pts=pts_4_center_near)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 27: 4DOF xyzy controller, curr mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_4_left)
    xz_controller.set_current_points(curr_pts=pts_4_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 28: 4DOF xyzy controller, curr mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_4_right)
    xz_controller.set_current_points(curr_pts=pts_4_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    print(f"output velocities: {vels}")

    print("\n### TEST 29: 4DOF xyzy controller, desired mode, move forward ###")
    xz_controller = IBVS_Controller(control_mode='4xyzy', interaction_mode='desired', num_pts=4)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0, 5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_4_center_near)
    xz_controller.set_current_points(curr_pts=pts_4_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 30: 4DOF xyzy controller, desired mode, move backward ###")
    xz_controller.set_desired_points(desired_pts=pts_4_center_far)
    xz_controller.set_current_points(curr_pts=pts_4_center_near)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 31: 4DOF xyzy controller, desired mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_4_left)
    xz_controller.set_current_points(curr_pts=pts_4_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 32: 4DOF xyzy controller, desired mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_4_right)
    xz_controller.set_current_points(curr_pts=pts_4_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 33: 4DOF xyzy controller, mean mode, move forward ###")
    xz_controller = IBVS_Controller(control_mode='4xyzy', interaction_mode='mean', num_pts=4)
    xz_controller.set_lambda_matrix(lambdas=[5.0, 5.0, 5.0, 5.0])
    xz_controller.set_desired_points(desired_pts=pts_4_center_near)
    xz_controller.set_current_points(curr_pts=pts_4_center_far)
    xz_controller.calculate_interaction_matrix()
    ...
    print("\n### TEST 34: 4DOF xyzy controller, mean mode, move backward ###")
    xz_controller.set_desired_points(desired_pts=pts_4_center_far)
    xz_controller.set_current_points(curr_pts=pts_4_center_near)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 35: 4DOF xyzy controller, mean mode, turn left ###")
    xz_controller.set_desired_points(desired_pts=pts_4_left)
    xz_controller.set_current_points(curr_pts=pts_4_right)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
    ...
    print("\n### TEST 36: 4DOF xyzy controller, mean mode, turn right ###")
    xz_controller.set_desired_points(desired_pts=pts_4_right)
    xz_controller.set_current_points(curr_pts=pts_4_left)
    xz_controller.calculate_interaction_matrix()
    vels = xz_controller.calculate_velocities()
