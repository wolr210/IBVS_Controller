...
if __name__ == '__main__':
    ### TEST 1:
    xy_controller = IBVS_Controller(control_mode='4xyzy', interaction_mode='mean', num_pts=4)
    xy_controller.set_lambda_matrix(lambdas=[1.0, 1.0, 1.0, 1.0])
    # print(xy_controller.lambda_matrix)
    xy_controller.set_current_points(curr_pts=[(-0.2, -0.2, 5.0), (0.2, -0.2, 5.0), (-0.2, 0.2, 5.0), (0.2, 0.2, 5.0)])
    # print(xy_controller.curr_pts)
    xy_controller.set_desired_points(desired_pts=[(-0.5, -0.5, 1.0), (0.5, -0.5, 1.0), (-0.5, 0.5, 1.0), (0.5, 0.5, 1.0)])
    # print(xy_controller.desired_pts)
    # print(xy_controller.errs)
    xy_controller.calculate_interaction_matrix()
    # print(xy_controller.L_e_est_pinv)
    vels = xy_controller.calculate_velocities()
    print(vels)