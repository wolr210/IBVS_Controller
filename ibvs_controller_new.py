    ...
    def calculate_interaction_matrix(self):
        ...
        if self.interaction_mode == 'curr':
            ...
            for i in range(self.num_pts):
                ...
                y = self.curr_pts[i][1]
                z = self.curr_pts[i][2]
                if self.degrees_of_freedom[0] is True:
                    temp_list.append(-1.0/z)
                    temp_list.append(0.0)
                if self.degrees_of_freedom[1] is True:
                    temp_list.append(0.0)
                    temp_list.append(-1.0/z)
                if self.degrees_of_freedom[2] is True:
                    temp_list.append(x/z)
                    temp_list.append(y/z)
                if self.degrees_of_freedom[3] is True:
                    temp_list.append(x*y)
                    temp_list.append(1.0 + y*y)
                if self.degrees_of_freedom[4] is True:
                    temp_list.append(-(1.0 + x*x))
                    temp_list.append(-x*y)
                if self.degrees_of_freedom[5] is True:
                    temp_list.append(y)
                    temp_list.append(-x)
